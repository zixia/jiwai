...
class Auth_OpenID_Message {
                          ...
                          $submit_text = "Continue")
    {
        ...
        $form_tag_attrs['onclick'] = "document.getElementById('btn').value='Connecting...';document.getElementById('btn').disabled='disabled';";
        ...
        $form .= sprintf("<input id=\"btn\" type=\"submit\" value=\"%s\" />\n",
                         $submit_text);
