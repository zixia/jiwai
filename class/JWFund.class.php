...
class JWFund
{
	...
	{
		$file_path = FRAGMENT_ROOT . 'page/fund.txt';
	...
	{
		$mc_key = JWDB_Cache::GetCacheKeyByFunction( array( 'JWFund', 'GetCacheKeyTotal' ), array($type));
		return $mc_key;
	}
