...
<li>
    <a href="/{$following['nameUrl']}/" rel="contact"><img width="48" height="48" src="${JWPicture::GetUserIconUrl($following['id'],'thumb48s')}" title="{$following['nameScreen']}" alt="{$following['nameScreen']}" />
