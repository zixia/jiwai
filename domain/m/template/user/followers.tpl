...
<li>
    <a href="/{$follower['nameUrl']}/" rel="contact"><img width="48" height="48" src="${JWPicture::GetUserIconUrl($follower['id'],'thumb48')}" title="{$follower['nameScreen']}" alt="{$follower['nameScreen']}" />
