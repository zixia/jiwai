...
<li>
    <a href="/{$follower['nameUrl']}/" rel="contact"><img width="48" height="48" src="${JWPicture::GetUserIconUrl($follower['id'],'thumb48s')}" alt="{$follower['nameScreen']}" alt="{$follower['nameScreen']}" />
