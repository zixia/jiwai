<div class="update">
	...
	<textarea id="jw_status" name="jw_status" mission="JWAction.updateStatus();" onKeyDown="JWAction.onEnterSubmit(event, this, true);" onKeyUp="textCounter(this.form.jw_status,$('count'),70);"></textarea>
	<ul class="f_gra">
