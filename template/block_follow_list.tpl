...
<!--${
	...
	<li class="hd"><a href="/{$user_row['nameUrl']}/" title="{$user_row['nameScreen']}"><em><img src="{$user_icon_url}" alt="{$user_row['nameScreen']}" title="{$user_row['nameScreen']}" class="buddy" icon="{$user_row['id']}" /></em>{$user_row['nameScreen']}</a></li>
<!--{/foreach}-->
</ul>
