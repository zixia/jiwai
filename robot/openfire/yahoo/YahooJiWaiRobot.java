...
public class YahooJiWaiRobot implements PacketListener, PacketFilter, MoMtProcessor {
    ...
    public static YahooJiWaiRobot yahoo_robot = null;
    ...
    static {
        ...
        mTransport = config.getProperty("yahoo.transport", System.getProperty("yahoo.transport") );
        mResource = config.getProperty("yahoo.resource", System.getProperty("yahoo.resource") );
    ...
    public static void main(String args[]) {
        yahoo_robot = new YahooJiWaiRobot();
        worker = new MoMtWorker(DEVICE, mQueuePath, yahoo_robot);
    ...
    public static void realConnect() {
        try{
            ...
            yahoo_robot.processOfflineMessage();
            roster = con.getRoster();

            con.addPacketListener(yahoo_robot , yahoo_robot);
