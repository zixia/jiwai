...
public class HelloFetion implements Runnable {
    ...
    private Set<String> mContactList = new HashSet<String>();
    ...
    /* buddy in uri */
    public void addContact(String buddy) {
        if (null == this.mClient) return;
        this.mClient.addContact(buddy);
    }

    /* async */
    public void getContactSet() {
        this.mClient.getContactList();
    }
    ...
    private void realLogin()
    {
        ...
        this.mClient.setAccount(mAccount);
        if (0 != this.mClient.login(this.mSipcProxy, this.mPassword))
        {
            System.out.println("SipcProxy: " + mSipcProxy);
    ...
    public void Login() {
        try {
            ...
            this.mOut.write("<config><user mobile-no=\"" + this.mAccount + "\" /><client type=\"PC\" version=\"2.1.0.0\" platform=\"W5.1\" /><servers version=\"0\" /><service-no version=\"0\" /><parameters version=\"0\" /><hints version=\"0\" /><http-applications version=\"0\" /></config>");
            this.mOut.flush();
            this.mOut.close();
