...
public class XiaoneiJiWaiRobot implements PacketListener, PacketFilter, MoMtProcessor {

    public static final String TALK_SERVER = "talk.xiaonei.com";
    public static final int TALK_PORT = 5222;
    public static final String DEVICE = "xiaonei";
    ...
    public static XiaoneiJiWaiRobot xiaonei_robot = null;

    public static String mServer = null;
    public static String mService = "talk.xiaonei.com";
    ...
    static {
        ...
        mServer = config.getProperty("xiaonei.server", System.getProperty("xiaonei.server") );
        mAccount = config.getProperty("xiaonei.account", System.getProperty("xiaonei.account") );
        mPassword = config.getProperty("xiaonei.password", System.getProperty("xiaonei.password") );
        mResource = config.getProperty("xiaonei.resource", System.getProperty("xiaonei.resource"));
        mStatus = config.getProperty("xiaonei.status", _mStatus );
    ...
    public static void main(String args[]) {
        xiaonei_robot = new XiaoneiJiWaiRobot();
        worker = new MoMtWorker(DEVICE, mQueuePath, xiaonei_robot);
    ...
    public static void connect(){
        try {
            ...
            e.printStackTrace();
            Logger.logError("Xiaonei Login failed");
        }
    }
    ...
    public static void realConnect() {
        ...
        try{
            ...
            xiaonei_robot.processOfflineMessage();
            roster = con.getRoster();

            con.addPacketListener(xiaonei_robot , xiaonei_robot);
