...
<DIV class=sidediv>
<div class="linkHelpMessager"><a href="/wo/feedback/" onClick="return JWAction.redirect(this);"><img src="<?php echo JWTemplate::GetAssetUrl('/images/feedback/feedback_08.jpg');?>" border="0"/></a></div>
...
<br>
<div class="linkHelpMessager"><a href="http://Help.JiWai.de/"><img src="<?php echo JWTemplate::GetAssetUrl('/images/feedback/feedback_13.jpg');?>" border="0"/></a></div>
<br>
<br>
</DIV><!-- sidediv -->
</DIV><!-- sidebar -->
