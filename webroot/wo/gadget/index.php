    ...
    <p class="top">窗可贴</p>
        <div id="wtMainBlock">
            ...
            <div class="rightdiv">
        		...
        		<div class="lookfriend">
            		<ul class="gadget">
                		<li><a href="http://help.jiwai.de/BlogbusWidget" class="smallblack" target="_blank"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_blogbus.gif'); ?>" title="博客大巴" border="0" /><p class="smallblack">博客大巴</p></a></li>
                		<li><a href="http://help.jiwai.de/SinablogWidget" class="smallblack" target="_blank"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_sina.gif'); ?>" width="30" height="30" title="新浪博客" /><p class="smallblack">新浪博客</p></a></li>
                		<li><a href="http://help.jiwai.de/MsnSpaceWidget" class="smallblack" target="_blank"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_msn.gif'); ?>" width="30" height="30" title="MSN空间" /><p class="smallblack">MSN空间</p></a></li>
                		<li><a href="http://help.jiwai.de/SohublogWidget" class="smallblack" target="_blank"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_sohu.gif'); ?>" width="30" height="30" title="搜狐博客" /><p class="smallblack">搜狐博客</p></a></li>
                		...
                		<li><a href="http://help.jiwai.de/QzoneblogWidget" class="smallblack" target="_blank"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_qzone.gif'); ?>" width="30" height="30" title="QQ空间" /><p class="smallblack">QQ空间</p></a></li>
                		<li><a href="http://help.jiwai.de/BlogCnWidget" class="smallblack" target="_blank"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_blogcn.gif'); ?>" width="30" height="30" title="博客中国" /><p class="smallblack">博客中国</p></a></li>
