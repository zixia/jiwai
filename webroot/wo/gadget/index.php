            ...
            <div class="rightdiv">
        		...
        		<div class="lookfriend">
            		<ul class="gadget">
                		...
                		<li><a href="http://help.jiwai.de/NeteaseblogWidget" class="smallblack"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_163.gif'); ?>" width="30" height="30" title="网易博客" /><p class="smallblack">网易博客</p></a></li>
                		...
                		<li><a href="http://help.jiwai.de/BloggerWidget" class="smallblack"><img src="<?php echo JWTemplate::GetAssetUrl('/images/gadget_blogger.gif'); ?>" width="30" height="30" title="Blogger" /><p class="smallblack">Blogger</p></a></li>
