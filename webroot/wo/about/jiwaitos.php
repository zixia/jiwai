   ...
   <div class="aboutrightmiddle">
     ...
     <div class="groupfont">
	   ...
	   <h3>基本条款</h3>
		...
		10. 不得在使用jiwai.de过程中触犯法律（包括但不局限于著作权法）。<br>
	    </p>
		<p style="margin-top:5px;"><span>违反这些协议中的任何一项将会导致你的jiwai.de帐号被终止。鉴于jiwai.de禁止此类作为和内容在本网站发生，您须理解并认同：你在使用jiwai.de服务时也许会浏览到此类内容，但jiwai.de对发布在本网站的内容不负有责任。</span>
		</p>
        <h4>综合条款</h4>
        <p>
