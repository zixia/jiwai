...
<ul>
	...
	<li ${$menu_nav=='statusexam'?'class="selected"':''}><a href="/wo/zdmin/statusexam">待审核JiWai更新 [Y]</a></li>
	<li ${$menu_nav=='statusexamed'?'class="selected"':''}><a href="/wo/zdmin/statusexamed">已审核JiWai更新 [Y]</a></li>
...
<ul>
  ...
  <li ${$menu_nav=='usermerge'?'class="selected"':''}><a href="/wo/zdmin/usermerge">用户合并操作</a></li>
</ul>
<h2>JiWai运营数据查询</h2>
<ul>
