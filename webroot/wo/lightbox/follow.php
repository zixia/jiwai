...
<?php if( $need_request ) { ?>
	...
	<p class="pad2" style="padding-top:0px;"><textarea id="request_follow" name="request_follow" class="requestFriend"></textarea></p>
<? } else { ?>
	<p class="pad1">是否同时打开通知呢？</p>
	<p><span class="pad2"><input type="radio" id="followoption1" name="notification" value="Y" checked="true"><label for="followoption1">是，在手机或者QQ等聊天软件上接收此人的消息</label></span></p>
	<p><span class="pad2"><input type="radio" id="followoption2" name="notification" value="N"><label for="followoption2">否，在网页上看到更新就好</label></span></p>
	<p class="pad3">如果你改了主意，你可以随时修改是否要接受通知</p>
<?php } ?>

	<p class="butt">
	  <input id="jwbutton" name="jwbutton" type="submit" class="submitbutton" value="确定" onclick="$('followForm').submit(); return false;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
