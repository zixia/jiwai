...
<div id="login" class="free reg_wid">
	<div class="mar_b20">
		...
		<dl class="pad_t8">
			...
			<dt></dt>
			<dd>
				<div><input type="button" value="登录" onclick="JWAction.login();"/>&nbsp;&nbsp;<input type="button" class="submitbutton" value="匿名发布" onClick="return JWAction.anonymous();" />&nbsp;&nbsp;<input type="button" class="closebutton" value="取消" onclick="JWSeekbox.remove();"/>
				</div>
			</dd>
		</dl>
		<div class="clear"></div>
